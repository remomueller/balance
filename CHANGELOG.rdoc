...
* Enhancements
  * Updating to Contour 1.0.1 and Twitter Bootstrap CSS/JS framework
  * Updating to Ruby 1.9.3-p125
  * Updating to Rails 3.2.5
...
* Testing
  ...
  * Continuous integration using TravisCI, http://travis-ci.org/remomueller/balance
